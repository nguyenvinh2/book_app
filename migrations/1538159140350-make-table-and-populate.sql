--FOR this step, a SCHEMA was actually NOT created TO house these instructions. The instructions were directly given TO postgres TO EXECUTE.

--This step removes existing tables NAME books.
DROP TABLE IF EXISTS books;

--CREATES the TABLE books WITH specified COLUMNS.
...
--Adds records into the table - ten record entries--
